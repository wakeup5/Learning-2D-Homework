...
// 원과 원의 충돌 처리(int 형)
inline bool CircleVsCircleCollision(POINT point1, int fRad1, POINT point2, int fRad2)
{
	int fTemp = sqrt(pow(point1.x - point2.x, 2) + pow(point1.y - point2.y, 2));
...
// 원과 원의 충돌 처리(float 형)
inline bool CircleVsCircleCollisionFloat(POINT point1, float fRad1, POINT point2, float fRad2)
{
...
//============================================================
// - 20150514 - ## commonMacroFunction ## - Chicken Crust
//============================================================
...
inline void LineMakes(HDC hdc, std::vector<POINT> vPt)
{
